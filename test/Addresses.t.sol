...
contract TestAddresses is Test {
    ...
    function test_changeAddress() public {
        assertEq(
            addresses.getAddress("DEPLOYER_EOA"), 0x9679E26bf0C470521DE83Ad77BB1bf1e7312f739, "Wrong current address"
        );

        address addr = vm.addr(1);
        addresses.changeAddress("DEPLOYER_EOA", addr, false);

        assertEq(addresses.getAddress("DEPLOYER_EOA"), addr, "Not updated correclty");
    }
    ...
    function test_changeAddressToSameAddressFails() public {
        ...
        address addr = addresses.getAddress("DEPLOYER_EOA");
        vm.expectRevert("Address: DEPLOYER_EOA already set to the same value on chain: 31337");
    ...
    function test_changeAddressChainId() public {
        ...
        assertEq(addresses.getAddress("DEPLOYER_EOA", chainId), addr, "Not updated correclty");
    }
    ...
    function test_addAddressDifferentChain() public {
        ...
        assertEq(addresses.getAddress("DEPLOYER_EOA"), 0x9679E26bf0C470521DE83Ad77BB1bf1e7312f739);
    }
    ...
    function test_getChangedAddresses() public {
        ...
        SavedAddresses[] memory savedAddresses = abi.decode(parsedJsons[0], (SavedAddresses[]));
