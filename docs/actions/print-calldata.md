...
3. Add Forge Proposal Simulator before the `run-proposal.sh` script.
4. Check the repository settings and make sure to have Read and Write Permissions enable on the Worflow Permissions section.
